...
/**
 * api to get preentitled swid-tags from database
 * @param  {} req
 * @param  {} res
 * @param  {} next
 */
const getPreentitledSwidTags = async (req, res, next) => {
    await dbAssetUsage.getPreentitledSwidTags(res);
    next();
};
...
router.get('/preentitled', validateParams, getPreentitledSwidTags);
