...
/**
 * api to get entitled swid-tags from database
 * @param  {} req
 * @param  {} res
 * @param  {} next
 */
const getEntitledSwidTags = async (req, res, next) => {
    await dbAssetUsage.getEntitledSwidTags(res);
    next();
};
...
router.get('/entitled', validateParams, getEntitledSwidTags);
