...
-----------------------------------------------------------------------------------------------
  ...
  .. list-table:: **user** of the model requests to perform and **action** on the model subscriber
      :widths: 10 10 10 10 40
      :header-rows: 1
  ...
  .. list-table:: creating the agreement on right-to-use by supplier
      :widths: 10 10 10 10 40
      :header-rows: 1
  ...
  .. list-table:: uploading of the agreement with the right-to-use by subscriber into LUM
      :widths: 10 10 10 10 40
      :header-rows: 1
  ...
  .. list-table:: alternative uploading of the agreement with the right-to-use by subscriber into LUM
      :widths: 10 10 10 10 40
      :header-rows: 1
