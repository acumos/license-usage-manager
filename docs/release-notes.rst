...
Version 0.26.0, 27 September 2019
---------------------------------
...
- LUM-server now finds the rightToUse under agreement for the swidTag
  on the asset-usage, returns either the entitelment with keys of the assetUsageDenial
...
- minimalistic validation of input data on agreement and permission/prohibition
  ...
  http status 460.  More validation is due later
